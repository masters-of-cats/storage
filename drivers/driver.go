...
type ProtoDriver interface {
	...
	GetQuotaUsage(id string) (int64, error)
	// GetVolumeSize returns the total disk size of the lower dirs which back a
	// mounted filesystem layer
	GetVolumeSize(id string) (int64, error)
}
